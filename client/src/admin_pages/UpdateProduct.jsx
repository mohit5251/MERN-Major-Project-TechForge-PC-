...
import { displayCategory, getSingleProduct, updateProducts } from "../API/ApiServices";
        ...
        try {
          ...
          if(response.status === 200){
            setData({
              ...
              stock: response.data.products.stock,
              specifications: JSON.stringify(response.data.products.specifications),
              image: "",
            })
          }
        } catch (error) {
